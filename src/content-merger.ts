 ...
 * @param {string} options.entryContent - The entry point content
 ...
 */
export function mergeContents({ entryContent, sourceContent, exportedItems, sourcePath }: MergeOptions): string {
